...
(function () {
  ...
  /** Renders a full map: coastline + ice shelves + live feature points, all fetched fresh.
   *  view: [minLon, minLat, maxLon, maxLat] approx bounding box used only to pick an SVG viewport;
   *  the projection itself is global polar-stereographic. */
